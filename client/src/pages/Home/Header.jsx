  ...
  return (
    <section className='bg-primary-100 w-full lg:h-screen h-[900px] flex flex-col lg:flex-row justify-end items-center min-h-[800px]' id='header'>
        ...
        <div className='lg:w-[50%] w-full h-full relative'>
            <img src={images.diariesIMG} className='absolute right-[50%] translate-x-[50%] xl:w-[400px] sm:w-[300px] w-[270px] max-w-[400px] z-10 rounded-2xl xl:top-[150px] lg:top-[190px] top-[50px] hover:scale-110 hover:z-50 duration-300' alt="" />
            <img src={images.paperIndustryIMG} className='absolute mx-auto right-[50%] -translate-x-6 2xl:w-[300px] xl:w-[250px] sm:w-[200px] w-[170px] 2xl:top-[400px] lg:top-[380px] sm:top-[230px] top-[220px] rounded-2xl z-20 hover:scale-110 duration-300 hover:z-50' alt="" />
            <img src={images.kitchenIMG} alt="" className='2xl:w-[300px] xl:w-[250px] sm:w-[200px] w-[170px] rounded-2xl absolute mx-auto left-[50%] translate-x-6 2xl:top-[400px] lg:top-[380px] sm:top-[230px] top-[220px] hover:scale-110 duration-300 hover:z-50' />
        </div>
