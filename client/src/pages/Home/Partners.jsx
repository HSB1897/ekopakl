...
const Partners = () => {
  return (
    <Container className='bg-secondary' id='partners'>
        ...
        <div className='grid gap-12 lg:gap-4 2xl:w-[1100px] lg:w-[500px] m-auto 2xl:grid-cols-4 lg:grid-cols-2 grid-cols-1 items-center justify-center w-full lg:mt-12 '>
